<?php
	...
	$german = array(
		'event_manager' => 'Veranstaltungen',
		'groups:enableevents' => 'Aktiviere Gruppenveranstaltungen',
		'event_manager:group' => 'Gruppenveranstaltungen',
		'event_manager:group:more' => 'Weitere Veranstaltungen',
		...
		'event_manager:menu:group_events' => 'Gruppen-Veranstaltungen',
		'event_manager:menu:new_event' => 'Neue Veranstaltung',
		'event_manager:menu:unsubscribe' => "Abmelden",
		'event_manager:menu:unsubscribe_confirm' => "Abmeldung bestätigen",
		'event_manager:menu:registration:completed' => "Anmeldung abgeschlossen",
		...
		'event_manager:edit:form:shortdescription' => 'Kurze Beschreibung',
		'event_manager:edit:form:organizer' => 'Organizer',
		'event_manager:edit:form:organizer_rsvp' => 'Add me as organizer to this event',
		'event_manager:edit:form:with_program' => 'Tagesprogramm einstellen?',
		...
		'event_manager:edit:form:start' => 'Beginn',
		'event_manager:edit:form:end' => 'Ende',
		'event_manager:edit:form:start_day' => 'Datum',
		'event_manager:edit:form:start_day:from' => 'Datum von',
		'event_manager:edit:form:start_day:to' => 'Datum bis',
		'event_manager:edit:form:endregistration_day' => 'Anmeldeschluss',
		'event_manager:edit:form:multiple_days' => 'Mehrere Tage?',
		'event_manager:edit:form:start_time' => 'Startzeit',
		'event_manager:edit:form:end_time' => 'Endzeit',
		'event_manager:edit:form:max_attendees' => 'Maximale Teilnehmeranzahl',
		'event_manager:edit:form:waiting_list' => 'Aktiviere Warteliste?',
		'event_manager:edit:form:register_nologin' => 'Anonyme Anmeldung zulassen?',
		'event_manager:edit:form:spots_left' => 'Spots left',
		'event_manager:edit:form:spots_left:full' => 'Teilnehmerplätze besetzt',
		'event_manager:edit:form:spots_left:waiting_list' => ' Interessenten auf der Warteliste',
...
Someone signed off from the '%s' event. You are moved from the waiting list to attending.",
		...
		'event_manager:event:rsvp' => 'um Antwort wird gebeten',
		...
		'event_manager:event:view:createdby' => 'Angelegt von',
		...
		'event_manager:error:max_attendees:not_numeric' => 'Wert für \'Max. Teilnehmer\' muss eine Zahl sein.',

		// relationships
		'event_manager:event:relationship:event_attending' => 'Teilnehmen',
		...
		'event_manager:event:relationship:event_interested:label' => 'Interessierte',
		...
		'event_manager:event:rsvp:event_full' => 'This event reached maximum Teilnehmer.',
		...
		'event_manager:event:relationship:message:event_attending' => 'Sie sind jetzt als Teilnehmer eingetragen',
		'event_manager:event:relationship:message:event_waitinglist' => 'Sie sind jetzt auf der Warteliste',
		'event_manager:event:relationship:message:event_interested' => 'Sie sind als Interessent eingetragen',
		...
		'event_manager:widgets:events:description' => 'Die nächsten Veranstaltungen',
		...
		'event_manager:settings:google_api_key' => 'Geben Sie Ihren \'Google API key\' ein',
		...
		'event_manager:settings:region_list' => 'Veranstaltungsregionen (getrennt mit Kommas)',
